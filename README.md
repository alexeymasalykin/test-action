...
```json
{
  "original_time": "15:00:00",
  "original_timezone": "UTC",
  "converted_time": "20:00:00",
  "converted_timezone": "Екатеринбург",
  "timezone_offset": "UTC+05:00"
}
```

**Поддерживаемые часовые пояса:**
- Российские города: Москва, Екатеринбург, Санкт-Петербург, Новосибирск, Казань, Челябинск, Самара, Омск, Красноярск, Владивосток, Иркутск, Хабаровск, Якутск, Магадан, Камчатка и другие
- Международные: Нью-Йорк, Лос-Анджелес, Чикаго, Лондон, Париж, Берлин, Токио, Пекин, Дубай, Сидней
- Также можно использовать стандартные названия часовых поясов (например: `Asia/Yekaterinburg`, `Europe/Moscow`)

**Примеры использования:**
- `time: "15:00"`, `timezone: "Екатеринбург"` → `20:00:00` (UTC+5)
- `time: "12:30"`, `timezone: "Москва"` → `15:30:00` (UTC+3)
- `time: "10:00"`, `timezone: "Нью-Йорк"` → `05:00:00` или `06:00:00` (зависит от летнего времени)

**Формат времени:**
- Поддерживаются форматы: `HH:MM` или `HH:MM:SS`
- Время должно быть в диапазоне 00:00:00 - 23:59:59
